...
dbutils.widgets.combobox("name", "defaultValue", ["choice1", "choice2"], "label")

dbutils.widgets.dropdown("name", "defaultValue", ["choice1", "choice2"], "label")
...
dbutils.widgets.multiselect("name", "defaultValue", ["choice1", "choice2"], "label")
